...
from seagull.nn.modules.utils.activations import get_activation_fn
...
class Linear(Module):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        Applies a linear transformation to the incoming data followed by an activation function.
        ...
        dropout_proba : float
            The dropout probability used.
        kwargs : Any
            Optional arguments for the choice of activation function.
        """
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        """
        Computes a forward pass through the linear layer, and applies the activation function.

        Parameters
        ----------
        input : torch.Tensor
            The input to the linear transformation.

        Returns
        -------
        torch.Tensor
            The transformed input, with the activation applied.
        """
