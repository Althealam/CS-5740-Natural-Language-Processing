...
def argparser():
    parser = ArgumentParser(description="Train a neural network for constructing privacy masks.")
    ...
    parser.add_argument("--experiment-name", type=str, help="Experiment name.", default="masking_experiment", required=True)
    parser.add_argument(
